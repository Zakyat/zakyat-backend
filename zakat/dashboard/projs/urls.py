...
from dashboard.projs.views import index, СampaignListView, CampaignDetailView, close_campaign, payment_option_create, \
    campaign_edit, campaign_create, payment_option_edit, payment_option_delete
